// Main JavaScript for Bookie Website
...
function initializeFAQ() {
    const faqData = [
        ...
        {
            question: "Is my data secure with Bookie?",
        ...
        },
        {
            ...
            answer: "Absolutely! Bookie supports importing bookmarks from Chrome, Firefox, Safari, Edge, and many other browsers."
        },
        {
...
function createDemoModal() {
    ...
    content.innerHTML = `
        <h3 style="margin-bottom: 16px; color: #1e293b;">Bookie Demo Video</h3>
        ...
        <p style="color: #64748b; margin-bottom: 24px;">Demo video would play here showing all the amazing features of Bookie!</p>
